...
// onsubmit
	...
	function onlyKorean(u_name) {
		var str=document.getElementById("u_name").value; 
	...
	<div class="content-wrapper" style="min-height: 855px;">
		...
		<div class="register-box">
			<div class="register-logo">
				<a href="#"> <b>Resume</b>History
				</a>
			</div>


			<p class="login-box-msg">새로운 사용자 등록</p>
			<form action="<%=contextPath%>/user/userSignUpResult" method="post"
				name="form" onsubmit="return checkSubmit()">
				<br>
				<div class="form-group has-feedback">
					<input type="text" class="form-control" id="u_id" name="u_id"
						placeholder="사번(해당년도 + 4자리)" required="required"
						onkeypress="inNumber()" onkeydown="removeChar()">
					<button type="button" class="btn btn-success" id="uIdCheck">중복확인</button>
					<div id="id_check"></div>
				</div>
				<div class="form-group has-feedback">
					<input type="text" class="form-control" id="u_company"
						name="u_company" value="비앤오소프트" readonly="readonly">
				</div>
				<div class="form-group has-feedback">
				...
				<div class="form-group has-feedback">
					<input type="password" class="form-control" id="u_pwd2"
						name="u_pwd2" maxlength="15" placeholder="비밀번호 확인">
				...
				<div class="form-group has-feedback">
					<input type="text" class="form-control" id="u_phone" name="u_phone"
						placeholder="핸드폰번호" onkeypress="inNumber()" onkeydown="removeChar()"
						onkeyup=" inputPhoneNumber(this);" maxlength="13">
					<div id="phone_check"></div>
				</div>

				<div class="form-group has-feedback">
					<input type="text" class="form-control" id="u_name" name="u_name" onkeyup="onlyKorean()"
						placeholder="이름"> <br> <select class="form-control"
						name="u_marry" value="u_marry" required>
						<option value="Y">기혼</option>
						<option value="N">미혼</option>
					</select> <select class="form-control" name="u_ms" value="u_ms">
				...
				<div class="form-group has-feedback">
					<input type="text" class="form-control" id="u_career"
						name="u_career" placeholder="경력(년 + 월)"><br>
					<div id="list"></div>
					<div id="callBackDiv">
						<input type="text" style="width: 500px;" id="roadFullAddr"
							name="u_address" placeholder="주소" required="true" readonly="true">
						<input type="button" class="btn btn-info" onClick="goPopup();"
							value="주소찾기">
					</div>
					<div class="form-group has-feedback">
						부서 <select class="form-control" name="d_id" value="d_id">
					...
					<div class="form-group has-feedback">
						직위 <select class="form-control" name="u_position"
							value="u_position">
					...
					<div class="form-group has-feedback">
						기술등급 <select class="form-control" name="u_tgrade" value="u_tgrade">
					...
					<div class="row">
						<div class="col-xs-8">
							<div class="checkbox icheck">
								<label>
									<div class="icheckbox_square-blue checked" aria-checked="true"
						...
						<div class="col-xs-4">
							<button type="submit"
								class="btn btn-primary btn-block btn-flat signupBtn"
								id="userInsert" name="userInsert">Sign Up</button>
							<button type="button" class="btn btn-primary btn-block btn-flat"
								onclick="javascript:location.href='<c:url value="/"/>user/userlogin'">Cancle</button>
						</div>
						<!-- /.col -->
					</div>
			</form>
...
function goPopup(){
	...
	var pop = window.open("<%=contextPath%>
	/user/userJuso", "pop",
