...
<%-- $("#resumeDelete").click(function() {
	...
	// 6. 특수기술
	$(function() {
		$("#specialTechInsertButton")
				.click(
						function() {

							$
									.ajax({
										url : "${pageContext.request.contextPath}/resume/resumeInsertSpecialTech",
										type : "POST",
										data : $("#resumeInsertSpecialTech")
												.serialize(),
										dataType : "text",
										success : function(data) {
											console.log("1 = 성공o / 0 = 실패x : "
											...
											if (data == "1") {
												$('#specialTechResult').text(
														"특수기술 등록 성공.");
												$('#specialTechResult').css("color",
														"blue");
											} else if (data == "0") {
												$('#specialTechResult').text(
														"특수기술 등록 실패.");
	...
	// 7. 스킬인벤토리
		$(function() {
		$("#skillInventoryInsertButton")
				.click(
						function() {

							$
									.ajax({
										url : "${pageContext.request.contextPath}/resume/resumeInsertSkillInventory",
										type : "POST",
										data : $("#resumeInsertSkillInventory")
												.serialize(),
										dataType : "text",
										success : function(data) {
											console.log("1 = 성공o / 0 = 실패x : "
											...
											if (data == "1") {
												$('#skillInventoryResult').text(
														"스킬인벤토리 등록 성공.");
												$('#skillInventoryResult').css("color",
														"blue");
											} else if (data == "0") {
												$('#skillInventoryResult').text(
														"스킬인벤토리 등록 실패.");
	...
	<div class="content-wrapper" style="min-height: 855px;">
		...
		<div class="row">
			...
			<div class="card card-primary col-md-5">
				<div class="card card-warning">
					...
					<!-- /.card-header -->
					<div class="card-body">
						<form role="form" id="resumeInsertSpecialTech">
							<input type="hidden" name="u_id" value="${resumeInfo.u_id }"></input>
							<input type="hidden" name="d_id" value="${resumeInfo.d_id }"></input>
							<input type="hidden" name="r_id" value="${resumeInfo.r_id }"></input>
							<div class="row">
								...
								<button type="button" id="specialTechInsertButton"
									name="specialTechInsertButton"
		...
		<div class="card card-primary col-md-12">
			<div class="card card-success">
				...
				<!-- /.card-header -->
				<div class="card-body">
					<form role="form" id="resumeInsertSkillInventory">
						<input type="hidden" name="u_id" value="${resumeInfo.u_id }"></input>
						<input type="hidden" name="d_id" value="${resumeInfo.d_id }"></input>
						<input type="hidden" name="r_id" value="${resumeInfo.r_id }"></input>
						<div class="row">
